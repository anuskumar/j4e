						...
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">speaker Profile</li>
								</ol>
							</nav>
							<h2 class="breadcrumb-title">speaker Profile</h2>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="speaker-widget">
								<div class="doc-info-left">
									...
									<div class="doc-info-cont">
										<h4 class="doc-name">Wayte Barlow</h4>
										<p class="doc-speciality">MCA, BE - 10+ Years Experience</p>
										<p class="doc-department"><img src="assets/img/specialities/specialities-05.png" class="img-fluid" alt="Speciality">DJ, Producer</p>
										<div class="rating">
							...
							<div class="tab-content pt-0">
												...
												<div class="experience-box">
													<ul class="experience-list">
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name">Princeton University</a>
																	<div>BDS</div>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name">John Hopkins University</a>
																	<div>MDS</div>
												...
												<div class="experience-box">
													<ul class="experience-list">
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name">Stanford Events Management</a>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name">Texas Event Planners</a>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name">Houston Dream Planners</a>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	...
																	<h4 class="exp-title">Best DJ Award</h4>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	...
																	<h4 class="exp-title">Certificate for International Artist</h4>
																	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
																</div>
															</div>
														</li>
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	...
																	<h4 class="exp-title">Award of Mix Engineer</h4>
																	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
																</div>
															</div>
														</li>
								...
								<div role="tabpanel" id="doc_locations" class="tab-pane fade">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="clinic-content">
													<h4 class="clinic-name"><a href="#">Smile Cute Tech Events Center</a></h4>
									...
									<div class="location-list">
										<div class="row">
											...
											<div class="col-md-6">
												<div class="clinic-content">
													<h4 class="clinic-name"><a href="#">The Family DJ, Producerry Clinic</a></h4>
													<p class="doc-speciality">MBA, MS - 12+ Years Experience</p>
													<div class="rating">
														<i class="fas fa-star filled"></i>
														<i class="fas fa-star filled"></i>
								...
								<div role="tabpanel" id="doc_reviews" class="tab-pane fade">
										...
										<ul class="comments-list">
											...
											<li>
												...
												<ul class="comments-reply">
													<li>
														<div class="comment">
															<img class="avatar avatar-sm rounded-circle" alt="User Image" src="assets/img/customers/customer1.jpg">
															<div class="comment-body">
																<div class="meta-data">
																	<span class="comment-author">Cedrica Large</span>
											...
											<li>
												<div class="comment">
													<img class="avatar avatar-sm rounded-circle" alt="User Image" src="assets/img/customers/customer2.jpg">
													<div class="comment-body">
														<div class="meta-data">
									...
									<div class="write-review">
										<h4>Write a review for <strong>Wayte Barlow</strong></h4>
