                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="{{ url('reseller/manage_event_store') }}" method="POST"
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="custom-controls-stacked">
                                                    <label class=""><input type="radio" checked value="1"
                                                            name="event_is_active"><span> Active</span></label>&nbsp;
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <label class=""><input type="radio" value="0"
                                                            name="event_is_active"><span> Inactive</span></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <button class="btn ripple btn-secondary" style="float: right; margin-left:10px;"
