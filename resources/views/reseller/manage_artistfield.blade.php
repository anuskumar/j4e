                                ...
                                <ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded">
                                    ...
                                    <li class="nav-item">
                                        <a class="btn ripple btn-info nav-item" style="float:right;"
                                            href="{{ url('reseller/artistfield_create') }}">Create Artistfield</a>
                                    </li>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                {{-- <h3 class="card-title">Artist Field</h3> --}}
                                            {{-- </div> --}}
                                            <div class="card-body">
                                                    ...
                                                    <table id="file-datatable"  class="border-top-0 dataTables  table table-bordered text-nowrap key-buttons border-bottom">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <form action="{{ url('artistfield/destroy',$val->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                    <a href="{{url('artistfield/view',$val->id)}}"><button type="button" class="btn btn-primary">view</button></a>
                                                                    <a href="{{url('artistfield/edit',$val->id)}}"><button type="button" class="btn btn-info">Edit</button></a>
