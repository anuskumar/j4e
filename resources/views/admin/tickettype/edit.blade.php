...
@section('admin_content')
				...
				<div class="row row-sm">
					...
					<div class="col-lg-10">
						<div class="card">
							<div class="card-body">
								<div class="mb-4 main-content-label">update TicketType</div>
								<form class="form-horizontal" action="{{url('tickettype/update') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group ">
										<div class="row">
											<div class="col-md-3">
												<label class="form-label">TicketType Name</label>
											</div>
											<div class="col-md-6">
												<input type="text" class="form-control" name="ticket_type_name"  value="{{ $data->ticket_type_name }}">
											</div>
										</div>
									</div>
                                    <div class="form-group ">
