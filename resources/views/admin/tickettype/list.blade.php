        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Ticket type</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="file-datatable"  class="border-top-0 dataTables  table table-bordered text-nowrap key-buttons border-bottom">
                            <thead>
                                <tr>
                                    <th>Sl</th>
                                    <th class="border-bottom-0">TicketType Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ url('tickettype/destroy',$val->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        <a href="{{url('tickettype/view',$val->id)}}"><button type="button" class="btn btn-primary">view</button></a>
                                        <a href="{{url('tickettype/edit',$val->id)}}"><button type="button" class="btn btn-info">Edit</button></a>
