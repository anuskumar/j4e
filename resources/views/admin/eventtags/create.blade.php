...
@section('page_title', 'Create Event Tag')

@section('breadcrumbs')
    <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ url('eventtags/list') }}">Event Tags</a></li>
    <li class="breadcrumb-item active" aria-current="page">Create Event Tag</li>
@endsection
    ...
    <div class="col-lg-4">
        <div class="card mg-b-20">
            <div class="card-body text-center">
                ...
                <h5 class="main-profile-name mb-1" id="preview-tag-name">New Event Tag</h5>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ url('eventtags/store') }}" method="POST" id="eventtag-create-form" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="card-footer d-flex justify-content-between">
                ...
                <button type="submit" form="eventtag-create-form" class="btn btn-primary waves-effect waves-light">
                    <i class="fe fe-save me-1"></i> Create Event Tag
                </button>
            </div>
        </div>
    </div>
...
jQuery(document).ready(function ($) {
    ...
    function updatePreview() {
        ...
        $('#preview-tag-name').text(name || 'New Event Tag');
    ...
    function handleImageFile(file) {
        ...
        if (file.size > 2 * 1024 * 1024) {
            ...
            $('#tag_image').val('');
            $('#tag-image-preview').attr('src', defaultImage);
