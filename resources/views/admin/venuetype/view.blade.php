<?php $page = 'venuetype/view'; ?>
@extends('admin.layout.app')

@section('page_title', 'View Venue Type')

@section('breadcrumbs')
    <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ url('venuetype/list') }}">Venue Types</a></li>
    <li class="breadcrumb-item active" aria-current="page">View Venue Type</li>
@endsection
    ...
    <div class="col-lg-4">
        <div class="card mg-b-20">
            <div class="card-body text-center">
                ...
                <h5 class="main-profile-name mb-1">{{ $data->venue_type_name ?? 'Venue Type' }}</h5>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group form-section-spacer">
                    <label class="form-field-label">Venue Type Name</label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="fe fe-tag"></i></span>
                        <input type="text" class="form-control view-field" value="{{ $data->venue_type_name ?? '-' }}" readonly>
                    </div>
                </div>
            ...
            <div class="card-footer d-flex justify-content-between">
                <a href="{{ url('venuetype/list') }}" class="btn btn-outline-secondary">
                    <i class="fe fe-arrow-left me-1"></i> Back to List
                </a>
                @if ($data)
                    <a href="{{ url('venuetype/edit', $data->id) }}" class="btn btn-primary waves-effect waves-light">
                        <i class="fe fe-edit me-1"></i> Edit Venue Type
                    </a>
                @endif
            </div>
        </div>
