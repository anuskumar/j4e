...
@section('admin_content')
    <style>
        ...
        /* Add your gradient styles for different indicators */
        .bg-primary-gradient {
            background: linear-gradient(to right, #4F52BA, #392F6B);
        }

        .bg-danger-gradient {
            background: linear-gradient(to right, #FF5454, #B20000);
        }

        .bg-info-gradient {
            background: linear-gradient(to right, #00A8FF, #003F81);
        }
                        ...
                        <div class="d-flex">
                            <div class="my-auto">
                                <svg enable-background="new 0 0 469.682 469.682" version="1.1"
                                    class="me-4 ht-60 wd-60 my-auto primary" viewBox="0 0 469.68 469.68" xml:space="preserve"
                            ...
                            <div class="project-content">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        @if (isset($invoice_complete_count))
                                            <span>{{ $invoice_complete_count }}</span>
                                        @endif
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="card  overflow-hidden project-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="my-auto">
                                <svg enable-background="new 0 0 438.891 438.891" class="me-4 ht-60 wd-60 my-auto danger"
                            ...
                            <div class="project-content">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        @if (isset($reseller_count))
                                            <span>{{ $reseller_count }}</span>
                                        @endif
                                    </li>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="card overflow-hidden project-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="my-auto">
                                <svg enable-background="new 0 0 477.849 477.849" class="me-4 ht-60 wd-60 my-auto success"
                            ...
                            <div class="project-content">
                                ...
                                <ul>
                                    <li>
                                        <strong>Completed</strong>
                                        @if (isset($outside_sell_count))
                                            <span>{{ $outside_sell_count }}</span>
                                        @endif
                                    </li>

                                    <li>
                                        <strong>Hold</strong>
                                        @if (isset($outside_hold_count))
                                            <span>{{ $outside_hold_count }}</span>
                                        @endif
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="project-content">
                                ...
                                <ul>
                                    <li>
                                        <strong>sold</strong>
                                        @if (isset($sold_ticket_sum))
                                            <span>${{ $sold_ticket_sum }}</span>
                                        @endif
                                    </li>
                                    <!--<li>-->
                        ...
                        <table class="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap table-striped ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="admin_assets/img/faces/11.jpg"><img class="profile-img brround " alt="profile image" src="admin_assets/img/faces/12.jpg"><img class="profile-img brround" alt="profile image" src="admin_assets/img/faces/2.jpg"></div>
                                    </td>
                                    <td>Web Design</td>
                                    <td>01 Jan 2020</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="admin_assets/img/faces/16.jpg"><img class="profile-img brround " alt="profile image" src="admin_assets/img/faces/8.jpg"><img class="profile-img brround" alt="profile image" src="admin_assets/img/faces/7.jpg"></div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="admin_assets/img/faces/3.jpg"><img class="profile-img brround " alt="profile image" src="admin_assets/img/faces/12.jpg"><img class="profile-img brround" alt="profile image" src="admin_assets/img/faces/15.jpg"></div>
                                    </td>
                                    <td>Web Development</td>
                                    <td>15 March 2020</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="admin_assets/img/faces/7.jpg"><img class="profile-img brround " alt="profile image" src="admin_assets/img/faces/6.jpg"><img class="profile-img brround" alt="profile image" src="admin_assets/img/faces/16.jpg"></div>
                                    </td>
                                    <td>Android</td>
                                    <td>15 March 2020</td>
                                    <td><span class="badge bg-success-gradient">Ongoing</span></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="admin_assets/img/faces/8.jpg"><img class="profile-img brround " alt="profile image" src="admin_assets/img/faces/11.jpg"><img class="profile-img brround" alt="profile image" src="admin_assets/img/faces/15.jpg"></div>
                                    </td>
                                    <td>Android</td>
                                    <td>15 March 2020</td>
                ...
                <div class="card-body p-0">
                    <div class="activity Activity-scroll">
                        <div class="activity-list">
                            <img src="admin_assets/img/faces/6.jpg" alt="" class="img-activity">
                        ...
                        <img src="admin_assets/img/faces/9.jpg" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity">
                            ...
                            </div> <img src="admin_assets/img/faces/3.jpg" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity">
                            ...
                            </div> <img src="admin_assets/img/faces/4.jpg" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity ">
                            ...
                            </div> <img src="admin_assets/img/faces/5.jpg" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity">
                            ...
                            </div> <img src="admin_assets/img/faces/6.jpg" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity">
                            ...
                            </div> <img src="admin_assets/img/faces/16.jpg" alt="" class="img-activity">
                            <div class="time-activity">
                                <div class="item-activity">
                                <p class="mb-0"><span class="h6 me-1">John Payne</span><span class="text-muted tx-13"> Add a new projects</span> <span class="h6 ms-1 added-project text-success">Free PSD Template</span></p><small class="text-muted ">3 days ago</small> </div>
                            </div> <img src="admin_assets/img/faces/10.jpg" alt="" class="img-activity">
