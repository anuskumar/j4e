								...
								<form class="form-horizontal" action="{{ url('admin/customer/store') }}" method="POST">
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-6">
												<input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="User Name" value="{{ old('name') }}" required>
												@error('name')
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="position-relative">
													<input type="password" id="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Password" required minlength="6">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="input-group">
													...
													<input type="tel" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="Phone Number" value="{{ old('phone') }}" pattern="[0-9\-\s()]+">
												</div>
												@error('phone')
