                ...
                <div class="main-profile-overview">
                    <div class="mb-3">
                        <div class="main-img-user profile-user mx-auto">
                            <img alt="{{ $data->name ?? 'Customer' }}"
                                src="{{ $profileImage }}"
                                onerror="this.src='{{ asset('admin_assets/img/faces/6.jpg') }}'">
                        </div>
                    </div>
                    <h5 class="main-profile-name mb-1">{{ $data->name ?? 'Customer' }}</h5>
                    <p class="main-profile-name-text text-muted mb-2">Customer Account</p>
                    @if ($data && $data->is_active == 1)
                        <span class="badge bg-success-transparent mb-3">Active</span>
                    @else
                        <span class="badge bg-warning-transparent mb-3">Inactive</span>
                    @endif
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-footer d-flex justify-content-between">
                <a href="{{ url('admin/customer/list') }}" class="btn btn-outline-secondary">
                    <i class="fe fe-arrow-left me-1"></i> Back to List
                </a>
                @if ($data)
                    <a href="{{ url('admin/customer/edit', $data->id) }}" class="btn btn-primary">
                        <i class="fe fe-edit me-1"></i> Edit Customer
                    </a>
                @endif
            </div>
        </div>
