<?php $page = 'eventtype/create'; ?>
@extends('admin.layout.app')

@section('page_title', 'Create Event Type')
    ...
    <div class="col-lg-4">
        <div class="card mg-b-20">
            <div class="card-body text-center">
                ...
                <h5 class="main-profile-name mb-1" id="preview-name">New Event Type</h5>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ url('eventtype/store') }}" method="POST" id="eventtype-create-form">
                    @csrf

                    <div class="mb-4 main-content-label">Basic Information</div>

                    <div class="form-group form-section-spacer">
                        <label class="form-field-label" for="name">Event Type Name <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group form-section-spacer">
                        ...
                        <p class="form-field-hint mb-0">Lower numbers appear first in lists and header menu. You can also drag rows on the list page.</p>
                        @error('sort_order')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card-footer d-flex justify-content-between">
                ...
                <button type="submit" form="eventtype-create-form" class="btn btn-primary waves-effect waves-light">
