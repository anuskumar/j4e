							...
							<div class="card-body">
								...
								<form class="form-horizontal">
									...
									<div class="form-group " >
										<div class="row">
											<div class="col-md-3">
												<label class="form-label" class="form-control">EventType Name</label>
											</div>
											<div class="col-md-6">
                                    ...
                                    <div class="card-footer">
                                        <a href="{{ url('eventtype/list') }}"><button type="button" class="btn btn-primary waves-effect waves-light" style="float:right;">Back</button></a>
                                    </div>
                                    {{-- <div class="form-group ">
										<div class="row">
											<div class="col-md-3">
