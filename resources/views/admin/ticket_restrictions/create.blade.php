...
@section('page_title', 'Create Ticket Restriction')
...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active" aria-current="page">Create Restriction</li>
@endsection
    ...
    <div class="col-lg-4">
        <div class="card mg-b-20">
            <div class="card-body text-center">
                ...
                <h5 class="main-profile-name mb-1" id="preview-name">New Restriction</h5>
                ...
                <div class="main-profile-contact-list">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div id="preview-restriction">Not set yet</div>
                        </div>
                    </div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ url('ticket_restrictions/store') }}" method="POST" id="restriction-create-form">
                    @csrf
            ...
            <div class="card-footer d-flex justify-content-between">
                ...
                <button type="submit" form="restriction-create-form" class="btn btn-primary waves-effect waves-light">
                    <i class="fe fe-save me-1"></i> Create Restriction
                </button>
            </div>
        </div>
    </div>
...
jQuery(document).ready(function ($) {
    function updatePreview() {
        ...
        $('#preview-name').text(name || 'New Restriction');
