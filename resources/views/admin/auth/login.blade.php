...
<html lang="en">
	...
	<body class="main-body bg-light  login-img">
		...
		<div id="global-loader">
			<img src="admin_assets/img/loaders/loader-4.svg" class="loader-img" alt="Loader">
		</div>
		<!-- /Loader -->
	...
	<div class="page">
		...
		<!--- Bootstrap Bundle js --->
		<script src="admin_assets/plugins/bootstrap/popper.min.js"></script>
		<script src="admin_assets/plugins/bootstrap/js/bootstrap.min.js"></script>

		<!--- Ionicons js --->
		<script src="admin_assets/plugins/ionicons/ionicons.js"></script>

		<!--- Moment js --->
		<script src="admin_assets/plugins/moment/moment.js"></script>

		<!--- Eva-icons js --->
		<script src="admin_assets/js/eva-icons.min.js"></script>

		<!--themecolor js-->
		<script src="admin_assets/js/themecolor.js"></script>
