<?php $page="speaker-profile-settings";?>
							...
							<div class="card services-card">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<input type="text" data-role="tagsinput" class="input-tags form-control" placeholder="Enter Services" name="services" value="Workshop " id="services">
										<small class="form-text text-muted">Note : Type & Press enter to add new services</small>
									</div> 
									<div class="form-group mb-0">
										<label>Specialization </label>
										<input class="input-tags form-control" type="text" data-role="tagsinput" placeholder="Enter Specialization" name="specialist" value="Digital Events,Tech Events" id="specialist">
