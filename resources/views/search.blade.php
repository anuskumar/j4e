				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-8 col-12">
							...
							<h2 class="breadcrumb-title">2245 matches found for : DJ, Producer In USA</h2>
						</div>
								...
								<div class="filter-widget">
									...
									<div>
										<label class="custom_check">
											...
											<span class="checkmark"></span> Male speaker
										</label>
									</div>
									<div>
										<label class="custom_check">
											<input type="checkbox" name="gender_type">
											<span class="checkmark"></span> Female speaker
										</label>
									</div>
								</div>
								<div class="filter-widget">
									...
									<div>
										<label class="custom_check">
											...
											<span class="checkmark"></span> DJ, Mix Engineer
										</label>
									</div>
									<div>
										<label class="custom_check">
									...
									<div>
										<label class="custom_check">
											...
											<span class="checkmark"></span> DJ, Producer
										</label>
									</div>
									<div>
										<label class="custom_check">
											<input type="checkbox" name="select_specialist">
											<span class="checkmark"></span> DJ, Songwriter
										</label>
									</div>
									<div>
										<label class="custom_check">
											<input type="checkbox" name="select_specialist">
											<span class="checkmark"></span> Artist, Producer
										</label>
									</div>
									<div>
										<label class="custom_check">
											<input type="checkbox" name="select_specialist">
											<span class="checkmark"></span> DJ, Engineer
										</label>
									</div>
								</div>
