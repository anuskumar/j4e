											...
											<div class="navbar">
												<div class="user-details mr-auto">
													<div class="float-left user-img">
														<a class="avatar avatar-sm mr-2" href="customer-profile" title="Cedrica Large">
															<img src="assets/img/customers/customer1.jpg" alt="User Image" class="rounded-circle">
															<span class="status online"></span>
														</a>
													</div>
													<div class="user-info float-left">
														<a href="customer-profile"><span>Cedrica Large</span></a>
										...
										<div class="call-contents">
											<div class="call-content-wrap">
												<div class="voice-call-avatar">
													<img src="assets/img/speakers/speaker-thumb-02.jpg" alt="User Image" class="call-avatar">
													<span class="username">Wayte Barlow</span>
												...
												<div class="call-users">
													<ul>
														<li>
															<a href="#">
																<img src="assets/img/customers/customer1.jpg" class="img-fluid" alt="User Image">
