							...
							<div class="row">
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar avatar-xxl">
												<img class="avatar-img rounded-circle" alt="User Image" src="assets/img/customers/customer8.jpg">
											</div>
								...
								<div class="col-md-12">
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar">
												<img class="avatar-img rounded" alt="User Image" src="assets/img/customers/customer8.jpg">
											</div>
											<div class="avatar">
												<img class="avatar-img rounded-circle" alt="User Image" src="assets/img/customers/customer8.jpg">
											</div>
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar-group">
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="assets/img/customers/customer8.jpg">
												</div>
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="assets/img/customers/customer2.jpg">
												</div>
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="assets/img/customers/customer3.jpg">
												</div>
												<div class="avatar">
